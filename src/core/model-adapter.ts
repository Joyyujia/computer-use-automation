...
export type ModelContext = { goal: string; targetUrl: string; availableBusinessOutcomes: Array<{ code: string; message: string }>; inputs: Record<string, unknown>; observation: Observation; history: Array<{ decision: DiscoveryDecision; outcome: string }>; remainingSteps: number };
